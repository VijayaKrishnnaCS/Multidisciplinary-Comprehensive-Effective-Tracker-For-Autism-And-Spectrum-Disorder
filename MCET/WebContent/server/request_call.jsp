...
<form class="form-horizontal home_form">
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <input id="passwordinput" name="passwordinput" type="password" placeholder="Enter your phone number" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-8">
  <input id="textinput" name="textinput" type="text" placeholder="Enter your email address" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-8">                     
    <textarea class="form-control" id="textarea" name="textarea">Enter any information you wish to share with us.</textarea>
  </div>
</div>
