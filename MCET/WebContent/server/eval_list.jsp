                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="table-responsive">
                                    ...
                                    <tbody>
                                    <s:iterator value="evalCritList" var="evalCrit">
                                        <tr>
                                            <td><s:property value="#evalCrit.name"/></td>
                                            <td><a href="case_treatment?evalCritO.id=<s:property value="#evalCrit.id"/>">View Treatment</a></td>
                                        </tr>
                                        </s:iterator>
                                    </tbody>
                                </table>
