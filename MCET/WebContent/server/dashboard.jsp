...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Assessment Result Per Department
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                           <iframe src="http://10.239.60.34:8719/mCETS/deptLevelDrillDown.jsp" width="800" height="345" frameborder="0"></iframe>
                        </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->
                ...
                <div class="col-lg-4">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Cases Per Department
                        </div>
                        <div class="panel-body">
                            <iframe src="http://10.239.60.34:8719/mCETS/caseSpecificDeptWise.jsp" width="418" height="345" frameborder="0"></iframe>
                        </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->
            ...
            <!-- /.row -->
           <div style="text-align:center"><img src="server/include/img/r.png"/></div>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
